/*
  Лабораторная работа No7/2
  Тестирование средней скорости обработки запросов.

  Тоже сгенерирован неиросетью. Результаты вычислений выведены в консоль. Нужно подставить адрес сайта для выполнения нагрузки.
 */
